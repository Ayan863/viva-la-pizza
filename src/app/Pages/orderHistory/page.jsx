  ...
  return (
    ...
    <Header/>
     ...
     <div className="text border p-2 w-[23%] rounded-md">
                  ...
                  {/* {item.name} */}
                  {/* {item.phone} */}
                  <p><span>Total:</span> {user.delivery.ordersData[0].spent}</p>
                  <p><span>Date:</span> {user.delivery.ordersData[0].date && (
                    <span>
                  ...
                  <p><span>Content:</span> {user.delivery.content}</p> 
                  <p><span>Location:</span>{user.delivery.location}</p>
                  <p><span>Duration:</span>{user.delivery.totalDuration}sec</p>
                </div>
